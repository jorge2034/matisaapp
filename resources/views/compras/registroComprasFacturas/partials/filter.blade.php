<div class="card card-primary">
    ...
    <div class="card-body" style="display: block;">
        ...
        {!! Form::open(['route'=>'compras.registroComprasFacturas.index','method'=>'GET', 'class'=>'form-inline'])!!}
        <section>
            ...
            @if($filtro)
                <div class="inputfilter">
                    <label>&nbsp;</label>
                    <a href="{{route('compras.registroComprasFacturas.index')}}" class="btn btn-default btn-filtro">Finalizar búsqueda</a>
                </div>
            @endif
        </section>
