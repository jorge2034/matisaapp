<div class="card card-primary">
    ...
    <div class="card-body" style="display: block;">
        ...
        {!! Form::open(['route'=>'inventario.marcas.index','method'=>'GET', 'class'=>'form-inline'])!!}
        <section>
            ...
            @if($filtro)
                <div class="inputfilter">
                    <label>&nbsp;</label>
                    <a href="{{route('inventario.marcas.index')}}" class="btn btn-default btn-filtro">Finalizar búsqueda</a>
                </div>
            @endif
        </section>
